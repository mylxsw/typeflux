...
enum StudioTheme {
    ...
    static let accentSoft = dynamic(light: NSColor(calibratedRed: 0.93, green: 0.96, blue: 1.0, alpha: 1), dark: NSColor(calibratedRed: 0.16, green: 0.22, blue: 0.33, alpha: 1))
    static let windowBackground = dynamic(light: NSColor(calibratedRed: 0.949, green: 0.946, blue: 0.941, alpha: 1), dark: NSColor(calibratedRed: 0.09, green: 0.10, blue: 0.13, alpha: 1))
    static let background = dynamic(light: NSColor(calibratedRed: 0.949, green: 0.946, blue: 0.941, alpha: 1), dark: NSColor(calibratedRed: 0.11, green: 0.12, blue: 0.15, alpha: 1))
    static let sidebar = dynamic(light: NSColor(calibratedRed: 0.949, green: 0.946, blue: 0.941, alpha: 1), dark: NSColor(calibratedRed: 0.10, green: 0.11, blue: 0.14, alpha: 1))
    static let surface = dynamic(light: NSColor(calibratedRed: 0.994, green: 0.993, blue: 0.989, alpha: 1), dark: NSColor(calibratedRed: 0.14, green: 0.16, blue: 0.20, alpha: 1))
    static let surfaceMuted = dynamic(light: NSColor(calibratedRed: 0.962, green: 0.960, blue: 0.955, alpha: 1), dark: NSColor(calibratedRed: 0.16, green: 0.18, blue: 0.23, alpha: 1))
    static let border = dynamic(light: NSColor(calibratedRed: 0.92, green: 0.915, blue: 0.905, alpha: 1), dark: NSColor(calibratedWhite: 0.25, alpha: 1))
    static let textPrimary = dynamic(light: NSColor(calibratedRed: 0.10, green: 0.10, blue: 0.11, alpha: 1), dark: NSColor(calibratedRed: 0.95, green: 0.96, blue: 0.98, alpha: 1))
    static let textSecondary = dynamic(light: NSColor(calibratedRed: 0.46, green: 0.46, blue: 0.47, alpha: 1), dark: NSColor(calibratedRed: 0.66, green: 0.69, blue: 0.76, alpha: 1))
    static let textTertiary = dynamic(light: NSColor(calibratedRed: 0.62, green: 0.62, blue: 0.63, alpha: 1), dark: NSColor(calibratedRed: 0.55, green: 0.58, blue: 0.66, alpha: 1))
